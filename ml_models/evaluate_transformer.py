...
class TransformerModelEvaluator:
    ...
    def __init__(self, model_path: str):
        ...
        """
        self.predictor = TransformerRacePredictor(model_path)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Transformer評価")
    ...
    evaluator = TransformerModelEvaluator(args.model)
